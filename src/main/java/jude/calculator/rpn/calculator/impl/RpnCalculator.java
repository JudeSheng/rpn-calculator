package jude.calculator.rpn.calculator.impl;
...
import jude.calculator.rpn.calculate.BinaryCalculateCore;
import jude.calculator.rpn.calculate.UnaryCalculateCore;
import jude.calculator.rpn.calculate.impl.RpnCalculateCore;
...
import jude.calculator.rpn.output.Printer;
import jude.calculator.rpn.storage.Caretaker;
	...
	public String interpret(String[] inputs) {
		if(inputs != null) {
			...
			for (String input : inputs) {
				if(RpnCalculatorUtils.isNumeric(input)) {
